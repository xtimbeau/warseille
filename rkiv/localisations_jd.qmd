...
On limite l'analyse à la métropole d'Aix-Marseille-Provence. Cela représente 26 000 carreaux 200mx200m pour 107 communes/arrondissements. Les opportunités sont les emplois, 95% des emplois occupés par les actifs de la métropole sont retenus de façon à exclure du périmètre les actifs qui travaillent par exemple à Paris ou en Corse.

On a retenu 21 143 carreaux d'opportunités pour un peu moins de 680k emplois.
...
La carte peut être basculée et la dimension "z" indique comme la couleur le nombre de personnes ou d'emplois par carreau. Des boutons en dessous des cartes permettent de télécharger les données.
