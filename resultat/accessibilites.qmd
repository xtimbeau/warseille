...
pal <- grDevices::colorRamp(c("green4","chartreuse", "yellow", "orangered3"), bias =1)( (0:60)/60)
...
t_access |> 
  ...
  left_join(communes |>
              st_drop_geometry() |>
              select(com22=INSEE_COM, NOM, POPULATION), by="com22") |> 
  transmute(
    ind=ind/4,
    tooltip=glue::glue(
    "{NOM} {com22}<br>
...
colors <- c("Marseille" = "chartreuse2", "Aix-en-Provence"="pink2", "Fos-sur-Mer"="deepskyblue", "autres" = "darkgoldenrod1")
