...
gg_cmd <- list(
  ...
  scale_color_manual(
    ...
    values = colors ),
  scale_y_continuous(oob=scales::squish, limits = c(0,1500)),
...
```
{{< fa excalamtion-triangle >}} La répartiton des déciles dans les zones sélectionnées est loin d'être homogène. Le graphique @fig-repartition matérialise cette remarque.
