...
bd_read("c200ze") |> 
  ...
  transmute(
    ...
    act_mobpro) |> 
  vroom::vroom_write("dnwld/ind_act_idINS_MetAM.csv", delim = ";")

download_link(
  link = "dnwld/ind_act_idINS_MetAM.csv",
  icon = "fa fa-download",
  class = "dbtn",
...
bd_read("c200ze") |> 
  ...
  transmute(
    ...
    act = tactocc1564 * ind_18_64) |> 
  vroom::vroom_write("dnwld/emp_empres_idINS_MetAM.csv", delim = ";")

download_link(
  link = "dnwld/emp_empres_idINS_MetAM.csv",
  icon = "fa fa-download",
  class = "dbtn",
