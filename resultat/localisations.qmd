...
On a retenu 21 143 carreaux d'opportunité pour un peu moins de 680 000 emplois.
...
La carte peut être basculée et la dimension *z* indique comme la couleur le nombre de personnes ou d'emplois par carreau (utilisez {{< kb Shift >>}} ou {{< kb Ctrl >>}} pour basculer). Des boutons en dessous des cartes permettent de télécharger les données utilisées pour les cartes.
