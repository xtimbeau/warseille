...
On limite l'analyse à la métropole d'Aix-Marseille-Provence. Cela représente 26 000 carreaux 200m x 200m pour 107 communes/arrondissements Les opportunités sont les emplois, 95% des emplois occupés par les actifs de la métropole sont couverts. On a retenu 21 143 carreaux d'opportunité pour un peu moins de 680 emplois.
...
```{r}
#| label: fig-resident
#| fig-cap: localisation des résidents (2017)
c200ze |> 
  mutate(
...
```{r}
#| label: fig-actifs
#| fig-cap: localisation des actifs (2020)
c200ze |> 
  mutate(
    act = tactocc1564 * ind_18_64) |> 
  filter(ind > 0, scot) |> 
