...
ggplot() +
  ...
  labs(caption="*Source* : MOBPRO, EMP 2019, C200, OSM, GTFS,  MEAPS. *version 2 (4/24)*")
...
gg <- bd_read("distrev") 
gg[[3]] <- gg[[3]] + labs(caption="*Source* : MOBPRO, EMP 2019, C200, OSM, GTFS,  MEAPS. *version 2 (4/24)*<br>Chacun des points représente un IRIS. Les IRIS carrés sont à Marseille, les losanges à Aix-en-Provence,<br>les ronds partout ailleurs.")
gg
```
