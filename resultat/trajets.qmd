...
```{r}
#| label: fig-carteco2
#| fig-cap: "Carte des émissions de CO~2~ pour les mobilités professionnelles"

bd_read("carte_co2") +
  theme_ofce_void() +
  labs(caption="*Source* : MOBPRO, MOBPERS, C200, MEAPS.<br>**Attention calcul préliminaire à confirmer.**")
