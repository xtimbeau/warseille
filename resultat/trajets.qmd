...
bd_read("meaps_from") |> 
    ...
    vroom::vroom_write("dnwld/co2_idINS_pdvR_MetAMP.csv", delim = ";")
...
bd_read("meaps_to") |> 
  ...
  vroom::vroom_write("dnwld/co2_idINS_pdvE_MetAMP.csv", delim = ";")
...
bd_read("km_iris") |> 
    st_drop_geometry() |> 
  vroom::vroom_write("dnwld/co2_ndv_IRIS_MetAMP.csv", delim = ";")

download_link(
  "dnwld/CO2_ndv_IRIS_MetAMP.csv",
  icon = "fa fa-download",
  class = "dbtn",
...
bd_read("km_iris_pol") |> sf::st_drop_geometry() |> 
  vroom::vroom_write("dnwld/co2_IRIS_pol_MetAMP.csv", delim = ";")
