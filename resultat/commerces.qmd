...
g2 <- ggplot(data |> filter(type != "agg", between(ndv, -2.5, 2.5), between(r, -2.5, 2.5))) +
  geom_hex_interactive(
    aes(x = ndv, y = se, weight = ind, tooltip = after_stat(count)), 
    binwidth = 0.25) +
