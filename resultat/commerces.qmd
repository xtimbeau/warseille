...
ggplot() +
  bd_read("decor_carte") +
  geom_sf(
    data = data |> filter(type == "alim") |> drop_na(wqse),
...
ggplot() +
  bd_read("decor_carte") +
  geom_sf(
    data= data |> filter(type == "commerces") |> drop_na(wqse),
    mapping= aes(fill = wqse), col=NA) + 
  scale_fill_paletteer_d("PNWColors::Sunset2", direction=-1, 
...
ggplot() +
  bd_read("decor_carte") +
  geom_sf(
    data= data |> filter(type == "sortie") |> drop_na(wqse),
    mapping= aes(fill = wqse), col=NA) + 
  scale_fill_paletteer_d("PNWColors::Sunset2", direction=-1, 
...
ggplot() +
  bd_read("decor_carte") +
  geom_sf(
    data= data |> filter(type == "sante") |> drop_na(wqse),
    mapping= aes(fill = wqse), col=NA) + 
  scale_fill_paletteer_d("PNWColors::Sunset2", direction=-1, 
...
ggplot(lorenz) + 
  ...
  geom_step()+
  theme_ofce() + 
  scale_color_manual(values = c(alim = "purple4", sortie = "orange4", sante = "seagreen", commerces = "yellow3")) +
  scale_y_log10()
