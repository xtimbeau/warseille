...
aa4 |> 
  ...
  gt::tab_source_note(gt::md(
    "*Source* : EMP 2019, calcul des auteurs.<br>
...
[^2]: Il n'existe pas de définition homogène de la ville du quart d'heure et certains auteurs retiennent un temps de parcours à pied aller retour de 15 minutes, bien plus court que la définition nous utilisons.
...
ggplot() +
  ...
  scale_fill_paletteer_d("fishualize::Bodianus_rufus", direction=1, 
                         name = "Proximité alimentaire : ", label = c("faible", "", "", "", "élevée"))+
  legend_h +
  ofce::ofce_caption(
    source=glue("C200, OSM, Fichiers fonciers, version {version}"),
    note ="L'indicateur de proximité aux aménités combine les surfaces commerciales ou de services dans un rayon de 15 minutes de marche ou de transport en commun avec une mesure de la diversité des commerces ou services accessibles. Il est décliné selon 4 grandes catégories (ici commerces alimentaires).")
```
...
ggplot() +
  ...
  geom_sf(
    ...
    mapping= aes(fill = factor(wqse)), col="white", linewidth = 0.01) + 
  scale_fill_paletteer_d("fishualize::Bodianus_rufus", direction=1, 
                         name = "Proximité sorties : ", label = c("faible", "", "", "", "élevée"))+
  legend_h +
  ofce::ofce_caption(
    source=glue("C200, OSM, Fichiers fonciers, version {version}"),
    note ="L'indicateur de proximité aux aménités combine les surfaces commerciales ou de services dans un rayon de 15 minutes de marche ou de transport en commun avec une mesure de la diversité des commerces ou services accessibles. Il est décliné selon 4 grandes catégories (ici restaurants, bars et cinéma).")
```
...
ggplot() +
  ...
  geom_sf(
    ...
    mapping= aes(fill = factor(wqse)), col="white", linewidth = 0.01) + 
  scale_fill_paletteer_d("fishualize::Bodianus_rufus", direction=1, 
                         name = "Proximité santé humaine : ", label = c("faible", "", "", "", "élevée"))+
  legend_h +
  ofce::ofce_caption(
    source=glue("C200, OSM, Fichiers fonciers, version {version}"),
...
ggg <- ggplot(comp) +
  ...
  guides(
    fill=guide_colorbar(
      theme=theme(legend.key.width = unit(24,"pt"),
                  legend.text = element_marquee(hjust=0.5, width=NULL),
                  legend.title = element_marquee(hjust=1)))) + 
  theme_ofce(
