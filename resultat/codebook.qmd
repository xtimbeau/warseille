...
-   `n` : nombre d'unité d'aménités accessibles en pour le rayon donné, calculé pour chaque type d'aménité.
...
-   `temps` : rayon de prise en compte des aménités (prend les valeurs "15m tc/w" pour 15 minutes marche/transport en commun ; "10m c" pour 10 minutes en voiture ; etc...)
